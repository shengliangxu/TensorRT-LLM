...
def attention(
    ...
    host_kv_cache_block_scale_pool_pointers: Optional[torch.Tensor],
    ...
    torch.ops.trtllm.attention_inplace(
        ...
        host_kv_cache_block_scale_pool_pointers, host_kv_cache_pool_pointers,
        host_kv_cache_pool_mapping, cache_indirection, kv_scale_orig_quant,
        kv_scale_quant_orig, out_scale, rotary_inv_freq, rotary_cos_sin,
        latent_cache, q_pe, block_ids_per_seq, is_fused_qkv, update_kv_cache,
        predicted_tokens_per_seq, layer_idx, num_heads, num_kv_heads, head_size,
        tokens_per_block, max_num_requests, max_context_length,
        attention_window_size, sink_token_length, beam_width, mask_type,
        quant_mode, q_scaling, position_embedding_type, rotary_embedding_dim,
        ...
        rotary_embedding_original_max_positions, use_paged_context_fmha,
